...
CMC operates a biochar production technology developed by BioMass Energy Techniques, Inc (BET), an original equipment manufacturer that owns the intellectual property for the BET BioMass Energy Systems. CMC utilizes a model BET 24PRD (pyrolysis rotary kiln). The rotary kiln is a pyro-processing device used to raise materials to a high temperature in a continuous process. Rotary kiln systems work by processing material in a rotating drum at high temperatures for a specified retention time to cause a physical change or chemical reaction in the material being processed. An aerial view of the facility in Greenville ME is shown in Figure 1.

# FIGURE 1. AERIAL VIEW OF THE CMC GREENVILLE FACILITY

As shown in Figure 2 below, the biochar manufacturing process is comprised of a combustion chamber (A), a retention chamber (B), a rotary kiln (C), a thermal oxidation chamber (E), and a water cooler. The combustion chamber A is where wood fuel is fed for heating of the process and primary combustion takes place. Up to 2,200 pounds per hour (lb/hr) of biomass (at an assumed moisture content of 40%) is gravity fed into this chamber. Chamber B is a high-temperature retention chamber which allows condensable gases to achieve complete combustion. A negative draft pulls the gases off the feedstock in Chamber A and into Chamber B.
...
During typical operations, up to 1,000 lb/hr of green biomass feedstock is fed into the rotary drum at Point 1. An auger conveyance system moves the feedstock materials into the Chamber C rotary drum. The rotating drum moves the material towards the high temperature retention Chamber B exposing it to extreme heat which serves to complete the pyrolysis process. The size and rotational speed of the Chamber C rotary drum determines the retention time and can be adjusted by the operator. The feedstock material reaches its desired state, following pyrolysis at Stage 3, and drops down into the discharge area in Stage 4. This process is fed into a water cooler and exits the system at Point 5. There is also an additional discharge point biochar for the biomass used to heat the drum, which is seen in Figure 3.

Currently, CMC acquires feedstock from one regional lumber company. The feedstock material is waste hardwood from lumber operations (primarily oak, ash, and maple), processed into chips of 2 inches or less at the lumber mill. This feedstock is transported to the CMC facility in Greenville by truck with typical payloads ranging from 10-30 tons per load from sawmill residuals. The lumber mill currently has no other use for this waste material. The actual quantities, loads and sources for all feedstock delivered to the facility are tracked via trip tickets.
...
During normal operations, any supplemental energy demands of the process required to meet proper operating temperatures are provided by biomass fuel that is a subset of the feedstock used for biochar production. For plant startup, the combustion chamber is charged with wood fuel and ignited using a propane torch. The quantity of propane used for each startup is recorded at the on-site propane storage tanks. The plant’s process equipment utilizes electricity supplied by the regional electric grid. Electricity consumption of the biochar production process is not currently metered independently. Instead, conservative estimates of power consumption are reported based on readings from the revenue-grade, utility-owned meter installed at the facility. Meter readings are recorded at the utility meter with and without biochar production operations. These data allow operators to calculate a conservatively based estimate of the power consumed by the biochar production equipment and supporting electrical loads (lighting and controls).

Biochar leaving the pyrolysis kiln is quenched using potable water supplied by the local utility. The quantity of water used is estimated on a weekly basis. Critical process parameters to assure consistent, high-quality biochar include biomass feed rate, process temperatures, and pyrolysis residence time. Each of the key parameters are continuously monitored to assure consistent operating conditions.

After quenching, biochar is conveyed to a packaging process where it is placed into super sacks for storage and shipping. Each super sack contains nominal one ton of biochar at approximately 15 to 30% moisture content to ensure safe storage. Sacks of biochar are loaded onto trucks for delivery to regional farms for use as an agricultural amendment. End users typically apply up to 3 tons of biochar per acre using the same tractor-towed equipment that they use for application of other fertilizers and land treatments.

CMC collects biochar samples on a weekly basis for proximate analyses provided by a qualified laboratory. To date, two biochar samples have been analyzed according to the thresholds defined in voluntary quality standards for biochar, namely the International Biochar Initiative (IBI) Certification Program, Test Category A Parameters. CMC also performs on-site biochar moisture determinations every 4 to 5 hours during production.

10/30/2024 V2.1 page 5 of 32
---
# 3. AUDIT SUMMARY
...
---
# 10/04/2024 Post-visit Request for Information

- Review of intake and production data collection
- Confirmation of company and facility administrative details
- Confirmation of facility environmental and social safeguards

# Follow-up request for information sent to CMC:

- Determination of biochar moisture, on-site records
...
- Operation of the pyrolysis reactor, including:
- Pyrolizer input (wet biomass input and quantification);
- Production and combustion of syngas;
- Collection, cooling of biochar;
- Storage and packaging of biochar;
- Sale and shipping of biochar to end users;
- Documenting all process operations, including input and output rates, biochar production and product sales, and amounts of by-products.
- Sampling and analysis of the biochar product.

Photographs of the facility and operations captured during the production facility site visit are provided in Appendix 2.

Verifiers also reviewed the processes and calculations used for the LCA and CORC quantifications. CMC utilizes the CarbonPilot software platform (https://carbonpilot.com/) to record, track, and report the Greenville facility biochar production, CORCs, and LCA emissions. Verifiers were granted online access to the CMC CarbonPilot account to enable review and verification of the facility inputs, data processing, and platform outputs.

# 3.2. PROCESS INPUTS & OUTPUTS

The CMC process uses waste biomass as its primary feedstock, with air input to support combustion of gasification products for internal heating, emission control via oxidizer combustion of residual syngas, and production of biochar. Energy-related inputs include fuel (diesel) for materials handling equipment, electricity for systems operation, and fuel (waste biomass and propane) for pyrolysis startup.

10/30/2024 V2.1 page 7 of 32
---
...
---
quantification. All product amounts included in inventory and dispatch sales are recorded. CMC also documents biochar and other product production in daily production logs. The LCA inputs are complete.

# 1.2.5 Verified Production

Acceptable. Conformance to the requirements of Section 1.2.5 of the Biochar methodology is documented and verified.

# 5.2.1 Feedstock Sustainability Proof

Acceptable. CMC has demonstrated that its feedstock is solely waste wood from regional lumber processing and sawmill facilities, which are otherwise destined for natural decomposition or incineration. Markets for alternative uses of vast amounts of waste wood are shrinking regionally. Shipping documents from the biomass suppliers and transporters and weigh scale records are provided as evidence.

# 5.4.3 Justification of Soil Temperature

Acceptable. An appropriate regional soil temperature of average 9°C in the project area was used in the LCA. Future applications of end use may occur in warmer regions.

# 5.5.2 Statement re: Double Counting

Acceptable. CMC is aware of end-user customer practices and assures no double counting is taking place.

# 5.5.3 Marketing / Branding Restrictions on end-user

Acceptable. Verifiers have found no evidence of double counting. Producer documents that purchaser assures that they or the end-user will not use biochar for energy production or combustion of any kind and will make no claim to the carbon sequestration from the use of the product.

Verifiers also reviewed the processes and calculations used for the LCA and CORC quantifications. CMC utilizes the CarbonPilot software platform (https://carbonpilot.com/) to record, track, and report the Greenville facility biochar production, CORCs, and LCA emissions. The platform is designed to automate Measurement, Reporting, and Verification (MRV), certifications, and product sales for participating production facilities. Verifiers were granted online access to the CMC CarbonPilot account to enable review and verification of the facility inputs, data processing, and platform outputs. Additional details regarding audit activities, documents reviewed, and observations during the audit process are summarized in Section 4.2 below and in Appendix 1.

# 4.2. AUDIT ISSUES & RECOMMENDATIONS

Findings for the verification of the production facility and the output audit include: (a) audit issues that identify findings that must be addressed to fully conform to the requirements of the Puro standard and biochar methodology, and (b) identification of opportunities for improvement that are recommended to improve future MRV processes. Key findings are summarized in Table 6. Those and other MRV recommendations are detailed in Sections 4.2.1 and 4.2.2 below.
...
- Use of fuels on-site contributing to Eproduction (diesel and propane) are complete, including emissions associated with traceability of UK DEFRA WTT factors for fuels production and supply;
- Quantification of and emission factors for super sack materials are included in LCA;
- Methane emissions from syngas combustion are properly documented;
...
For this reporting period, all CMC biochar sold is claimed to be intended for end use as soil amendments. As such, the analyses conducted and results reported are conformant to the Puro rules (verified as meeting the US regulation Code 336 requirements, which are applicable for soil amendments seeking reimbursement for USDA conservation practices and which serve as the local regulations). Additional analyses may be required should other end uses of CMC biochar be applied in future sales (such as IBI Type B testing for animal feedstocks – where, in accordance with section 1.1.7 of the Puro Biochar Methodology, suppliers must screen the biochar).
...
Recommendations for improving the quality of data and accuracy of the LCA and CORC claims in the future include:

- Prioritizing the recommended improvements to quantification of dry biochar produced specified in Section 4.2.1 above (scale calibration for biochar mass and balance calibration for moisture biochar determinations).
- Monitored water use: There is no monitoring of water consumption used for quenching biochar and cooling certain pyrolysis system components. Although this is an omission from the Puro methodology requirements, LCA emissions associated with water use are estimated (based on moisture content of biochar product) and actual use is minimal. However, this lack of data could lead to an underestimation of the environmental impact related to water use and implementing a measurement of water use is recommended.
- On site biochar moisture determinations: In addition to calibration of the balance used for wet and dry measurement of biochar sample mass, a moisture analyzer such as Ohaus MB32 or equivalent is recommended. These instruments, designed for analyses using ASTM D1762-84 standard test method for chemical analysis of wood charcoal would add reliability and credibility to the on-site moisture determinations.
- Energy use MRV improvements: Consumption of diesel fuel for materials handling, propane for pyrolysis startup and stabilization, and electricity use for operation of the pyrolysis system and supporting infrastructure (all components of Eproduction), are currently not directly measured. To improve LCA accuracy and prevent over reporting of emissions due to conservative energy use estimates, it is recommended that the use of each energy source be measured and recorded for each weekly operating period. Bulk storage gauges for diesel and propane currently in use at the site are sufficient to create these weekly records. A second power meter specific to the biochar process energy use may be required to isolate and record the power consumption. These weekly energy use records can then be normalized to production rates during a given reporting period (e.g., unit of energy consumed/dry tonne biochar produced).
- Oxidizer Exhaust Emissions: A full regulatory emissions test of the system exhaust gas was conducted in October 2023. Emissions of all required pollutants were documented as well below the respective limits and there, it is not anticipated that the Maine DEP will require another test in the foreseeable future. As an indication of continued regulatory compliance, it is recommended that the facility continuously monitor and record oxidizer and exhaust stack temperature at a minimum, to demonstrate that operating conditions are consistent with those recorded during the compliance testing.
...
1. Puro.Earth, "Puro Standard General Rules," Version 3.1, [Online]. Available: https://puro.earth/documents/.
2. Puro.Earth, "Biochar Methodology," Edition 2022 V3, Feb 2024. [Online]. Available: https://puro.earth/methodologies/.
3. Puro.Earth, "Guidance for biochar suppliers on determining the dry mass of biochar produced and delivered," 2022. [Online].
...
Soil temperature calculation and justification, link

# Proof of No Double-Counting

Proof of no double-counting. No C-negative branding used by CMC and no attempts to monetize the carbon credits except through Puro.

# Proof of Sales

Proof of sales. Copies of sold product invoices provided.
...
---
# CORC Report Summary - Biochar_Final_v2.xlsx

# 1.1.8

Evidence of safe handling and transport is provided and adequate for the production facility.

Y Biochar itself is handled safely. It is moved using heavy equipment, not manually.

No relevant product quality requirements exist in the jurisdiction, so the IBI standard defines the requirements. Biochar is acceptable for use according to USDA's BioPreferred Program and the NRCS. The biochar has not been tested for the organic contaminants named in IBI's "Type B" tests.

# 1.1.7

Biochar products meet the product quality requirements existing in the jurisdiction where biochar is used and for the specific applications considered.

# 6.6 in General Rules

The SDG outcome meets the claims below:

- Specific: must refer to a specific individual outcome rather than being overly broad or abstract.
- Cause-and-effect relationship: must establish a direct and inherently clear cause and-effect relationship between the carbon removal activity and the impact, i.e., the impact should be additional and attributable to the CO2 Removal activity.
- Quantitative metric: Numeric measurement allows for objective assessment and comparison as per Section 4 of SDG assessment requirements.
- Accuracy: can be determined without relying heavily on input assumptions.
- Manageable MRV: Pragmatic MRV processes limit the costs of data collection.

# 1.2.1

Evidence of Production Facility eligibility under the general rules of Puro Standard.

Y See Standing Data Confirmation section, above.

# 1.2.2

The Production Facility demonstrate Environmental and Social Safeguards.

Y See Standing Data Confirmation section, above.

# 1.2.3

CO2 Removal Supplier shall be able to demonstrate additionality, meaning that the project must convincingly demonstrate that the CO2 removals are a result of carbon finance. Even with substantial non-carbon finance support, projects can be additional if investment is required, risk is present, and/or human capital must be developed. To demonstrate additionality, CO2 removal Supplier must provide full project financials and counterfactual analysis based on.
...
Baseline emission scenario is assumed to be zero.

Puro additionality questions to suppliers v1.8

# Environmental Safeguards are demonstrated through:

- Environmental Impact Assessment (EIA)
- Environmental permit
- Other documentation approved by the Issuing Body on the analysis and management of the environmental and social impacts

# 1.2.2

Environmental safeguards are demonstrated through Environmental Evaluation Report and Maine DEP air permit.

A1164AN.pdf (air permit)

Environmental Evaluation Report_CMC_updated July 2024.pdf

Report - CMC Air Emissions Test Report -Oct 2023.pdf

CMC Biochar Safety.pdf

# 1.1.8

Safety measures include, but are not limited to, providing a Material Safety Data Sheet, post-production quenching and cooling of biochar, and appropriate flue gas treatment systems.

Worker safeguards are in place as standard operating practices. Biochar MSDS and Environmental, Health, and Safety Manual provided.

# 6.7.3.1 in General Rules

The risk estimation shall be quantitative, and the Overall Risk Effect shall be given in percentage of the Output volume. The Reversal risk estimation shall consider all material risks arising from:

- Nature-induced risks (e.g., flora, fauna, or climate conditions).
- Human-induced risks (e.g., design and construction faults, operational risks).
- Geopolitical risks (e.g., potential effects of the legal and political environment).
- Any additional factors mentioned in the applicable Methodology.

No risk of reversal because biochar is applied on fields or as other soil enhancement uses.

Customer attestations that the biochar is not burned were provided.
...
# Figure A2-1. CMC 2-inch Hardwood Feedstock Supply

# Figure A2-2. CMC Biochar Production Process
...
William Chatterton is an Environmental Scientist with 28 years’ experience in technology evaluation and demonstration, project management, air pollution monitoring, testing, and regulation. He serves as Program Manager at 350Solutions and manages projects and programs for commercial and government clients. Previously the past 20 years at Southern Research, Mr. Chatterton has managed, and supported programs designed to integrate, demonstrate, and evaluate technology performance in the advanced energy field. Technology demonstrations and evaluations that he has been involved with include technologies designed to promote sustainable energy sources, increase energy use and efficiency, mitigate GHG and other emissions, and in most cases provide other social and economic benefits to potential users. Mr. Chatterton has been heavily involved in the evaluation of numerous emerging energy technologies, distributed generation technologies, and technologies relevant to transportation and oil and gas markets. Mr. Chatterton’s roles in support of these projects has included program and project management from administrative and technical perspectives, lead or technical support on test plan development, method development and validation, design and implementation of field-testing activities, data evaluation and presentation, and reporting of results. He has managed numerous projects for both commercial and government clients.

# 350Solutions: 08-2019 – Present

Verification Program Manager: As Verification Program Manager, Mr. Chatterton manages and executes technology performance demonstrations and verifications of emerging energy (efficiency and green building) and transportation technologies, primarily for U.S. governmental agencies, energy research associations, and state energy agencies. These performance evaluations generally involve evaluation of commercial feasibility, economic impacts (installation, operating, and capital costs, simple payback, and return on investment), environmental impacts (primarily greenhouse gas and criteria pollutant emission reductions), and technology performance. He also manages and monitors 350Solutions’ quality management programs and ISO accreditations.

# Southern Research Institute: 1999 - 2019

Program Manager, Energy & Environment Technologies: As Program Manager, Mr. Chatterton has managed and executed several technology performance demonstrations and verifications of emerging energy (efficiency and green building) and transportation technologies, primarily for U.S. governmental agencies, energy research associations, and state energy agencies. Mr. Chatterton also has direct experience with management and execution of projects under DOE and DoD grants and contracts. He has recently managed activities on three large DoD projects including Demonstration of a Solar Thermal Combined Heating, Cooling and Hot Water System Utilizing an Adsorption Chiller for DoD Installations, Demonstration and Verification of the Performance of Microturbine Power Generation Systems Utilizing Renewable Fuels, and the Electric Power with Small Scale Organic Rankine Cycle (ORC) Engine/Generator Technology demonstration.
